...
const actionLabel = (a: string) => ({ SUBMIT: '提交上报', PROCESS: '处理', RETURN: '退回', VOID: '作废', NOT_TRUE: '认定不属实', TRANSFER: '批转', TO_COMMITTEE: '上报委员会' } as any)[a] || a
const actionColor = (a: string) => ({ SUBMIT: '#0891B2', PROCESS: '#22C55E', RETURN: '#F59E0B', VOID: '#DC2626', NOT_TRUE: '#6B7280', TRANSFER: '#8B5CF6', TO_COMMITTEE: '#EC4899' } as any)[a] || '#6B7280'
