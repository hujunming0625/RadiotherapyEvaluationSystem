...
export const useAppStore = defineStore('app', {
  state: (): AppState => {
    return {
      ...
      layout: 'top', // layout布局：强制顶部导航，无左侧边栏
      isDark: wsCache.get(CACHE_KEY.IS_DARK) || false, // 是否是暗黑模式
      currentSize: wsCache.get('default') || 'default', // 组件尺寸
      theme: wsCache.get(CACHE_KEY.THEME) || {
        // 主题色
        elColorPrimary: '#0891B2',
        // 左侧菜单边框颜色
        leftMenuBorderColor: '#A5F3FC',
        // 左侧菜单背景颜色
        leftMenuBgColor: '#f0fafb',
        // 左侧菜单浅色背景颜色
        leftMenuBgLightColor: '#E8F1F6',
        // 左侧菜单选中背景颜色
        leftMenuBgActiveColor: 'rgba(8,145,178,0.12)',
        // 左侧菜单收起选中背景颜色
        leftMenuCollapseBgActiveColor: 'rgba(8,145,178,0.12)',
        // 左侧菜单字体颜色
        leftMenuTextColor: '#164E63',
        // 左侧菜单选中字体颜色
        leftMenuTextActiveColor: '#0891B2',
        // logo字体颜色
        logoTitleTextColor: '#fff',
        // logo边框颜色
        logoBorderColor: '#0891B2',
        // 头部背景颜色
        topHeaderBgColor: '#fff',
        // 头部字体颜色
        topHeaderTextColor: '#164E63',
        // 头部悬停颜色
        topHeaderHoverColor: '#f0fafb',
        // 头部边框颜色
        topToolBorderColor: '#A5F3FC'
      }
    }
  },
  getters: {
